...
namespace nn { namespace nex { namespace JobDataStoreGetObject<nn::nex::DataStoreApiVersionTraits<(nn::nex::DATASTORE_API_VERSION)1> > {

JobDataStoreGetObject();
~JobDataStoreGetObject();
Initialize(unsigned int, nn::nex::DataStoreLogicServerClientInterface*, nn::nex::DataStorePrepareGetParam const&, unsigned int, bool, unsigned long, unsigned long, unsigned long, unsigned int, int, nn::nex::DataStoreGetObjectEventListenerTemplate<unsigned long>*, unsigned long, unsigned char*, unsigned long, bool, unsigned long*, nn::nex::DataStoreReqGetInfo const*);
