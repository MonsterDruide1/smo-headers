...
namespace agl { namespace lght { namespace LightPrePassLightMgr<al::LppLightDataBase<al::CausticsLightParam>, agl::lght::LightPrePass::Context, agl::lght::LightPrePass::CallbackArg> {
...
destroyImpl_(al::LppLightDataBase<al::CausticsLightParam>&);
destroyFinishImpl_();
calcPrepareImpl_();
calcImpl_(al::LppLightDataBase<al::CausticsLightParam>&);
updateGpuPrepareImpl_() const;
updateGpuImpl_(al::LppLightDataBase<al::CausticsLightParam> const&) const;
updateViewGpuPrepareImpl_(int, agl::lght::LightPrePass::Context const&) const;
updateViewGpuImpl_(al::LppLightDataBase<al::CausticsLightParam> const&, int, agl::lght::LightPrePass::Context const&) const;
drawPrepareImpl_(int, agl::lght::LightPrePass::Context const&, agl::lght::LightPrePass::CallbackArg&) const;
drawDebugTestImpl_(agl::DrawContext*, al::LppLightDataBase<al::CausticsLightParam> const&, int, agl::lght::LightPrePass::Context const&) const;
genMessagePrepareImpl_(sead::hostio::Context*);
genMessageImpl_(sead::hostio::Context*, al::LppLightDataBase<al::CausticsLightParam>&, int);
listenPropertyEventPrepareImpl_(sead::hostio::PropertyEvent const*);
listenPropertyEventImpl_(sead::hostio::PropertyEvent const*, al::LppLightDataBase<al::CausticsLightParam>&, int);
