/home/monsterdruide1/OdysseyDecomp/toolchain/clang-3.9.1/bin/clang++ \
    ...
    -DNON_MATCHING \
    -Ionline-headers -Ionline-headers/sead -Iaarch64 \
    -DVER_100 -O3 -g   -D SWITCH -D NNSDK -D MATCHING_HACK_NX_CLANG -mcpu=cortex-a57+fp+simd+crypto+crc \
    ...
    #-I. -Iaarch64 -INintendoSDK/include -Isead/include -Iagl/include \
