...
namespace al
{
    ...
    public:
        HitSensorKeeper(int);
        bool addSensor(al::LiveActor *sensorHost, char const *sensorName, u32 typeEnum, float radius, u8 maxCount, const sead::Vector3f *position, const sead::Matrix34f *matrix, const sead::Vector3f &scale);
        void update(void);
